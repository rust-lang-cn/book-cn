...
>
> 1. **本站翻译已部分更新至 Rust 1.52 版**，这是目前网上最新的版本，最后更新时间 2021 年 5 月 17 日。
...
> 5. <a href="https://rustwiki.org/zh-CN/book" style="color:red;">本站支持文档中英文切换</a>，点击页面右上角语言图标可切换到相同章节的英文页面，**英文版每天都会自动同步一次官方的最新版本**。
